...
// import { BiometricScanner } from '@/components/BiometricCapture/BiometricScanner';
// import { QuickCheckSliders } from '@/components/BaselineScan/QuickCheckSliders';
...
type ScanStep = 'entry' | 'quick-check' | 'biometric-setup' | 'biometric-capture' | 'results' | 'saved';

const BaselineScanFlow: React.FC = () => {
...
export default BaselineScanFlow;
